// Updated the z-index of the image link checker
...
if (!em && sv && !pw) {
    ...
    $lc_butt.click(function () {
        ...
        for (b; b < laLength; b++) {
            ...
            jQuery($linkArr[b]).addClass('siteLink');
    ...
    $wpt_butt.click(function () {
        ...
        dURL = testURL + "url=" + siteURL + pn + "?device=immobile";
        mURL = testURL + "url=" + siteURL + pn + "?device=mobile";
        if (confirm('----------------------------------------\n' +
